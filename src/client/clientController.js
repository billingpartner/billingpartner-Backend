...
exports.createClient = async (req, res) => {
    try {
        const { customerName, contactNumber, customergstin, customercompanyname, customeraddress, customeraddressline2, customeremailid } = req.body;
...
exports.updateClient = async (req, res) => {
    try {
        ...
        client.customercompanyname = customercompanyname !== undefined ? customercompanyname : client.customercompanyname;
